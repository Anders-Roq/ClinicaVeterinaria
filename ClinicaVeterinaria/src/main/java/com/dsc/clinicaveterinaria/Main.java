...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Animais
        Gato g1 = new Gato("Fofinho", "Gato", "Laranja", 'M', LocalDate.of(2020, 5, 10), cliente1);
        Cachorro c1 = new Cachorro("Rex", "Cachorro", "Pastor Alemão", 'M', LocalDate.of(2022, 7, 1), cliente1);
        Gato g2 = new Gato("Luna", "Gato", "Branca", 'F', LocalDate.of(2019, 1, 1), cliente2);
        Cachorro c2 = new Cachorro("Chuchu", "Cachorro", "Pug", 'M', LocalDate.of(2021, 5, 9), cliente3);
        Cachorro c3 = new Cachorro("Mel", "Cachorro", "Golden Retriever", 'F', LocalDate.of(2020, 3, 15), cliente4);
        Cachorro c4 = new Cachorro("Thor", "Cachorro", "Bulldog", 'M', LocalDate.of(2018, 8, 20), cliente4);
        Gato g3 = new Gato("Nina", "Gato", "Siamesa", 'F', LocalDate.of(2022, 2, 14), cliente5);
        Cachorro c5 = new Cachorro("Bob", "Cachorro", "Labrador", 'M', LocalDate.of(2019, 11, 30), cliente5);
